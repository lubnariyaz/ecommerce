...
class onlineshopping_model():
    ...
    def onlineshopping_add_model(self, data, custid):
        self.cur.execute(f"INSERT INTO online_shopping(customer_id, category_id, product_id, amount) VALUES ('{custid}', '{data['category_id']}', '{data['product_id']}', '{data['amount']}')")
        return make_response({"message":"Record Added Successfully"}, 201)
